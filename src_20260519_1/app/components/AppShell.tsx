...
export default function AppShell({
  ...
  const [displayName, setDisplayName] = useState(tenantName || tenantId);

  useEffect(() => {
    const user = auth.currentUser;
    setDisplayName(user?.email || tenantName || tenantId);
  }, [tenantId, tenantName]);
